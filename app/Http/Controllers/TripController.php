...
class TripController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('trips/trips',['trips'=>$filteredTrips,'branches'=>$branches,'bags'=>$bags,'users'=>$users]);
    }
    ...
    public function store(Request $request)
    {
        ...
        }else if(Auth::check() & (Auth::User()->role == "branch"))
        {
            Trip_Log::create([
                'trip_id' => $The_trip->id,
        ...
        return redirect()->route('packaging');
    }
    ...
    public function receive($id)
    {
        ...
        }else if(Auth::check() & (Auth::User()->role == "receiving"))
        {
            Trip_Log::create([
                'trip_id' => $Trip->id,
